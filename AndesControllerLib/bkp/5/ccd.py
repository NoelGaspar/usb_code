...
class CCD_230_42(_CCD):
	...
	_default_clock_params = {
		...
		# Internal clocks
		'CLKI1':{'dev':-1, 'pol':0, 'nbits':0,  'add_bot': 0, 'add_top': 0, 'volt_bot':0, 'volt_top':0,  'clockId':24},
		'CLKI2':{'dev':-1, 'pol':0, 'nbits':0,  'add_bot': 0, 'add_top': 0, 'volt_bot':0, 'volt_top':0,  'clockId':25},
		'CLKI3':{'dev':-1, 'pol':0, 'nbits':0,  'add_bot': 0, 'add_top': 0, 'volt_bot':0, 'volt_top':0,  'clockId':26},
		'CLKI4':{'dev':-1, 'pol':0, 'nbits':0,  'add_bot': 0, 'add_top': 0, 'volt_bot':0, 'volt_top':0,  'clockId':27},
		'CLKI5':{'dev':-1, 'pol':0, 'nbits':0,  'add_bot': 0, 'add_top': 0, 'volt_bot':0, 'volt_top':0,  'clockId':28},
		'CLKI6':{'dev':-1, 'pol':0, 'nbits':0,  'add_bot': 0, 'add_top': 0, 'volt_bot':0, 'volt_top':0,  'clockId':29},
		'CLKI7':{'dev':-1, 'pol':0, 'nbits':0,  'add_bot': 0, 'add_top': 0, 'volt_bot':0, 'volt_top':0,  'clockId':30},
		'CLKI8':{'dev':-1, 'pol':0, 'nbits':0,  'add_bot': 0, 'add_top': 0, 'volt_bot':0, 'volt_top':0,  'clockId':31},
	}

	## Default value for biases
	# bias_vect order name bus device polarity nbits address voltage
	_default_bias_params = {
		'BHV1A':{'dev':3, 'pol':0, 'nbits':24, 'address': 0, 'voltage':0, 'biasId': 33, 'voltType': 'high'},
		'BHV2A':{'dev':3, 'pol':0, 'nbits':24, 'address': 1, 'voltage':0, 'biasId': 34, 'voltType': 'high'},
		'BHV3A':{'dev':3, 'pol':0, 'nbits':24, 'address': 2, 'voltage':0, 'biasId': 35, 'voltType': 'high'},
		'BHV4A':{'dev':3, 'pol':0, 'nbits':24, 'address': 3, 'voltage':0, 'biasId': 36, 'voltType': 'high'},
		'BHV5A':{'dev':3, 'pol':0, 'nbits':24, 'address': 4, 'voltage':0, 'biasId': 37, 'voltType': 'high'},
		'BHV6A':{'dev':3, 'pol':0, 'nbits':24, 'address': 5, 'voltage':0, 'biasId': 38, 'voltType': 'high'},
		'BHV7A':{'dev':3, 'pol':0, 'nbits':24, 'address': 6, 'voltage':0, 'biasId': 39, 'voltType': 'high'},
		'BHV8A':{'dev':3, 'pol':0, 'nbits':24, 'address': 7, 'voltage':0, 'biasId': 40, 'voltType': 'high'},
		'BLV1A':{'dev':3, 'pol':0, 'nbits':24, 'address': 8, 'voltage':0, 'biasId': 41, 'voltType': 'low' },
		'BLV2A':{'dev':3, 'pol':0, 'nbits':24, 'address': 9, 'voltage':0, 'biasId': 42, 'voltType': 'low' },
		'BLV3A':{'dev':3, 'pol':0, 'nbits':24, 'address':10, 'voltage':0, 'biasId': 43, 'voltType': 'low' },
		'BLV4A':{'dev':3, 'pol':0, 'nbits':24, 'address':11, 'voltage':0, 'biasId': 44, 'voltType': 'low' },
		'BLV5A':{'dev':3, 'pol':0, 'nbits':24, 'address':12, 'voltage':0, 'biasId': 45, 'voltType': 'low' },
		'BLV6A':{'dev':3, 'pol':0, 'nbits':24, 'address':13, 'voltage':0, 'biasId': 46, 'voltType': 'low' },
		'BLV7A':{'dev':3, 'pol':0, 'nbits':24, 'address':14, 'voltage':0, 'biasId': 47, 'voltType': 'low' },
		'BLV8A':{'dev':3, 'pol':0, 'nbits':24, 'address':15, 'voltage':0, 'biasId': 48, 'voltType': 'low' },

#    'BHV1B':{'dev':5, 'pol':0, 'nbits':24, 'address': 0, 'voltage':0, 'biasId':49, 'voltType': 'high'},
#    'BHV2B':{'dev':5, 'pol':0, 'nbits':24, 'address': 1, 'voltage':0, 'biasId':50, 'voltType': 'high'},
#    'BHV3B':{'dev':5, 'pol':0, 'nbits':24, 'address': 2, 'voltage':0, 'biasId':51, 'voltType': 'high'},
#    'BHV4B':{'dev':5, 'pol':0, 'nbits':24, 'address': 3, 'voltage':0, 'biasId':52, 'voltType': 'high'},
#    'BHV5B':{'dev':5, 'pol':0, 'nbits':24, 'address': 4, 'voltage':0, 'biasId':53, 'voltType': 'high'},
#    'BHV6B':{'dev':5, 'pol':0, 'nbits':24, 'address': 5, 'voltage':0, 'biasId':54, 'voltType': 'high'},
#    'BHV7B':{'dev':5, 'pol':0, 'nbits':24, 'address': 6, 'voltage':0, 'biasId':55, 'voltType': 'high'},
#    'BHV8B':{'dev':5, 'pol':0, 'nbits':24, 'address': 7, 'voltage':0, 'biasId':56, 'voltType': 'high'},
#    'BLV1B':{'dev':5, 'pol':0, 'nbits':24, 'address': 8, 'voltage':0, 'biasId':57, 'voltType': 'low' },
#    'BLV2B':{'dev':5, 'pol':0, 'nbits':24, 'address': 9, 'voltage':0, 'biasId':58, 'voltType': 'low' },
#    'BLV3B':{'dev':5, 'pol':0, 'nbits':24, 'address':10, 'voltage':0, 'biasId':59, 'voltType': 'low' },
#    'BLV4B':{'dev':5, 'pol':0, 'nbits':24, 'address':11, 'voltage':0, 'biasId':60, 'voltType': 'low' },
#    'BLV5B':{'dev':5, 'pol':0, 'nbits':24, 'address':12, 'voltage':0, 'biasId':61, 'voltType': 'low' },
#    'BLV6B':{'dev':5, 'pol':0, 'nbits':24, 'address':13, 'voltage':0, 'biasId':62, 'voltType': 'low' },
#    'BLV7B':{'dev':5, 'pol':0, 'nbits':24, 'address':14, 'voltage':0, 'biasId':63, 'voltType': 'low' },
#    'BLV8B':{'dev':5, 'pol':0, 'nbits':24, 'address':15, 'voltage':0, 'biasId':64, 'voltType': 'low' },
	}
